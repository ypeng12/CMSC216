 ...
 * instruction because it tries to perform division with a second operand of
 * zero.
 *
...
int main(void) {
  Nelovo nelovo;
  /* program1 has an instruction that incorrectly tries to divide by zero,
     while program2 is valid */
  Mach_word program1[NUM_WORDS]= {0x4a0004bc, 0x4a400849, 0x4a800913,
                                  0x4ac00000, 0x136ac000, 0x00000000};
