 ...
 *
 * Tests calling rm() to remove some files from a filesystem.  This test
 * just checks for correct operation of rm(), it does not check that there
 * are no memory leaks or errors in the heap.
 *
